# Generated by Django 2.1.15 on 2019-12-31 13:23
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rank_status', models.CharField(choices=[('ULTIMATE', 'Ultimate'), ('PREMIUM', 'Premium'), ('PLATINUM', 'Platinum'), ('UNDEFINED', 'Undefined'), ('PRO_BASIC', 'Pro_basic'), ('PRO_ULTIMATE', 'Pro_ultimate'), ('BASIC', 'Basic')], default='UNDEFINED', max_length=200)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('DEACTIVATED', 'Deactivated'), ('NEWBIE', 'Newbie'), ('REGISTERED_CONFIRMED', 'Registerd_confirmed')], default='NEWBIE', max_length=200)),
                ('rank_status', models.CharField(choices=[('ULTIMATE', 'Ultimate'), ('PREMIUM', 'Premium'), ('BASIC', 'Basic')], default='BASIC', max_length=200)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('graduation_date', models.DateTimeField(default=datetime.datetime(2019, 12, 31, 16, 23, 10, 730880))),
