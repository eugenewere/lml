# Generated by Django 2.1.7 on 2019-11-07 09:20
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_created', models.DateField(default=datetime.datetime(2019, 11, 7, 12, 20, 28, 368387))),
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('status', models.CharField(choices=[('PREMIUM', 'Premium'), ('DEACTIVATED', 'Deactivated'), ('REGISTERED_CONFIRMED', 'Registerd_confirmed'), ('NEWBIE', 'Newbie')], default='NEWBIE', max_length=200)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('county_number', models.IntegerField(max_length=200)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone_number', models.CharField(max_length=20)),
                ('date_of_birth', models.DateField(default=datetime.datetime(2019, 11, 7, 12, 20, 28, 362367))),
                ('landmark', models.CharField(max_length=100)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('paid_date', models.DateField(default=datetime.datetime(2019, 11, 7, 12, 20, 28, 374376))),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('amount', models.FloatField()),
                ('paid_to', models.CharField(blank=True, max_length=200, null=True)),
                ('paid_date', models.DateField(default=datetime.datetime(2019, 11, 7, 12, 20, 28, 375370))),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('customer', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='lmlappadmin.Customer')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_from', models.DateField(default=datetime.datetime(2019, 11, 7, 12, 20, 28, 365359))),
                ('date_to', models.DateField(default=datetime.datetime(2019, 11, 7, 12, 20, 28, 365359))),
